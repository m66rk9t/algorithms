...
```
DLR(先序遍历):(25, 36, 52, 81, 15, 42, 74, 63, 21, 45, 31, 88), 相应满二叉树节点个数为
LDR(中序遍历):(52, 36, 15, 42, 81, 25, 74, 21, 63, 31, 88, 45), 相应满二叉树节点个数为
LRD(后序遍历):(52, 42, 15, 81, 36, 21, 88, 31, 45, 63, 74, 52), 相应满二叉树节点个数为
```
